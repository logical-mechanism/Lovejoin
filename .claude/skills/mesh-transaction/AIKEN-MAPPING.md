...
import {
  ...
  conStr2,
  conStr3,
  conStr, // conStr(N, fields) for any index
  integer,
  byteString,
  builtinByteString,
  pubKeyAddress,
  ...
  mConStr2,
  mConStr3,
  mConStr, // mConStr(N, fields) for any index
  mPubKeyAddress,
  mScriptAddress,
  mOutputReference,
  mTxOutRef,
...
const parameterizedScript = applyParamsToScript(
  ...
  [byteString(ownerPkh), integer(42), pubKeyAddress(ownerPkh, stakeCredHash)],
