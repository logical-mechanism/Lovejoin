...
const hash1 = resolveDataHash({ alternative: 0, fields: [] }, "Mesh");

// Hash JSON-format data
const hash2 = resolveDataHash({ constructor: 0, fields: [] }, "JSON");

// Hash CBOR-format data
const hash3 = resolveDataHash("d8799f9fff", "CBOR");
```
...
const { scriptHash, scriptCbor } =
  serializer.deserializer.script.deserializePlutusScript({
    code: "59010100...",
    version: "V2",
  });

// Get key hash from pool ID
const keyHash = serializer.deserializer.cert.deserializePoolId("pool1...");
```
